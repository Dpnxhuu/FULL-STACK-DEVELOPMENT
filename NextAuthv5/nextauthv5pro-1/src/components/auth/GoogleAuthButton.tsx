...
import { signIn } from "next-auth/react"; // ✅ NEW import add karo
...
export function GoogleAuthButton({ label }: { label: string }) {
  // ❌ OLD — manual URL banake redirect kar rahe the (hataya)
  // const handleGoogleLogin = () => {
  //   const googleAuthUrl = `https://accounts.google.com/o/oauth2/v2/auth?...`;
  //   window.location.href = googleAuthUrl;
  // };

  // ✅ NEW — NextAuth khud poora OAuth URL banayega, redirect karega, callback handle karega
  const handleGoogleLogin = () => {
